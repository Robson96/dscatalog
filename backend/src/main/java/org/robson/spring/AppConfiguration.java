    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.robson");
                servletContext.setInitParameter("tapestry.development-modules", "org.robson.services.DevelopmentModule");
